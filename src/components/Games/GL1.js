...
const SlidePuzzle = () => {
  const initialImages = [
    { id: 1, src: "/images/level1/00.jpg", alt: "Image 1" },
    { id: 2, src: "/images/level1/01.jpg", alt: "Image 2" },
    { id: 3, src: "/images/level1/02.jpg", alt: "Image 3" },
    { id: 4, src: "/images/level1/10.jpg", alt: "Image 4" },
    { id: 5, src: "/images/level1/11.jpg", alt: "Image 5" },
    { id: 6, src: "/images/level1/12.jpg", alt: "Image 6" },
    { id: 7, src: "/images/level1/20.jpg", alt: "Image 7" },
    { id: 8, src: "/images/level1/21.jpg", alt: "Image 8" },
    { id: 9, src: "/images/level1/22.jpg", alt: "Image 9" },
  ];
  ...
  const handlePreview = () => {
    setPreviewImage("/images/level1/edu.jpg");
  };
  ...
  return (
    <section
      className={`slidegame ${showCongrats ? "congrats-background" : ""}`}
    >
      {showCongrats ? (
        ...
        <>
          <div className="pre-img">
            <img src="/images/level1/edu.jpg" alt="preview pic" />
          </div>
          <div
            className="drop-zone"
